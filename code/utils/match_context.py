...
def read_excel_subsheet(file_path, sheet_name, column_names):
    try:
        ...
        if sheet_name in xl.sheet_names:
            ...
            print("Subsheet '{}' does not exist.".format(sheet_name))
            return None
...
def main():
    Version = "original"
    repoName = "libvips"
    funcFile = "~/LLM_test/work/"+repoName+"/"+repoName+"_allFunc.xlsx"
    dataFile = "~/LLM_test/work/"+repoName+"/"+repoName+"_context_"+Version+".xlsx"
    resultFile = "~/LLM_test/work/"+repoName+"/"+repoName+"_selectedFunc_context_"+Version+".xlsx"
