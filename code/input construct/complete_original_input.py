...
def main():
    ...
    repoName = "lvgl"
    root_path = "~/LLM_test/work/" + repoName + "/"
    funcFile = root_path + repoName +"_selectedFunc_context_original.xlsx"
    dataFile = root_path + repoName + "_context_original.xlsx"
    resultFile = root_path + repoName + "_complete_original_input.xlsx"
    ...
    for index, row in function_df.iterrows():
        ...
        partCode = process_code(confusedCode)
