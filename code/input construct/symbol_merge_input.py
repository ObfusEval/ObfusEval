...
version = "redis"
semantic_df = pd.read_excel(root_path+version+"\\"+version+"_original_input.xlsx", usecols=["fileName", "funcName",  "function_header",  "initialInput"])   #fileName	funcName	function_header	initialInput
...
semantic_df.to_excel(root_path+version+"\\"+version+"_symbol_input.xlsx", index=False)
