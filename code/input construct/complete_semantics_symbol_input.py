...
version = "libvips"
semantic_df = pd.read_excel(root_path+version+"\\"+version+"_complete_semantics_input.xlsx", usecols=["fileName", "funcName",  "function_header",  "initialInput"])   #fileName	funcName	function_header	initialInput

all_dict_df = pd.read_excel(root_path+version+"\\"+"all_dict_se_"+version+".xlsx", usecols=["Function", "Function_confused", "Used_Macros", "Used_Macros_confused", "Used_Global_Vars", "Used_Global_Vars_confused", "Used_Structs", "Used_Structs_confused"])
...
semantic_df.to_excel(root_path+version+"\\"+version+"_complete_semantics_symbol_input.xlsx", index=False)
